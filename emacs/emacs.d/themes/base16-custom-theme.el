...
(let ((base-gray-00 (plist-get base16-grayscale-light-colors :base00)) ;; #f7f7f7
  ...
  (custom-theme-set-faces
   ...
   `(org-level-3 ((t (:foreground ,base-gray-05))))
   `(org-level-4 ((t (:foreground ,base-3024-0E))))
   `(org-level-5 ((t (:foreground ,base-3024-0F))))
   `(org-level-6 ((t (:foreground ,base-gray-04))))
   `(org-level-7 ((t (:foreground ,base-gray-04))))
   `(org-level-8 ((t (:foreground ,base-gray-04))))
