...
(let ((base-gray-00 (plist-get base16-grayscale-light-colors :base00)) ;; #f7f7f7
  ...
  (custom-theme-set-faces
   ...
   `(org-headline-done ((t (:background ,base-gray-00 :foreground ,base-gray-02 :weight normal))))
   `(org-todo ((t (:background ,base-gray-00))))
   `(org-hide ((t (:foreground ,base-gray-06))))
   `(org-block ((t (:background ,base-gray-00))))
   `(org-block-begin-line ((t (:foreground ,base-gray-02 :background ,base-gray-00))))
   ...
   `(org-level-7 ((t (:foreground ,base-gray-04 :weight bold))))
   `(org-level-8 ((t (:foreground ,base-gray-04 :weight bold))))
   `(org-link ((t (:underline t :foreground ,base-gray-0D))))
   `(org-link ((t (:underline t :foreground ,base-gray-0D))))
   `(org-priority ((t (:foreground ,base-gray-07 :weight normal))))
